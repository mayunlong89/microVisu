...
#'@param col colour palette: including all the types of the "display.brewer.all()" in the RColorBrewer pacakage
#'@return
#'
#'@export
#'
...
taxBarPlot <- function(otuTab, metaData, classToPlot, topNum, col){
  ...
  #dplyr::arrange(otuTabMeanFinal,desc(total)) ##use this code to allow leverage others' packages
  #we can directly use the library("your_pkg")
